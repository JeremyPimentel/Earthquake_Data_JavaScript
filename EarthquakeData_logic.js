...
//We create a third tile layer for Dark theme
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  console.log("working as well");
    ...
    function tectonicStytle(feature) {
      return {
        opacity: 3,
        fillOpacity: 3,
        // fillColor: getColor(feature.properties.mag),
  ...
  // Creating a GeoJSON layer with the retrieved data.
   L.geoJson(data, {
    ...
    // We set the style for each circleMarker using our tectonicStyle function.
  style: tectonicStytle,
